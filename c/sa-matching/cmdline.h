...
#define CMDLINE_PARSER_PACKAGE "sa-matching"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "sa-matching"
#endif
...
struct gengetopt_args_info
{
  ...
  int accelerant_arg;	/**< @brief Accelerant type (default=0) (default='0').  */
  char * accelerant_orig;	/**< @brief Accelerant type (default=0) original value given at command line.  */
  const char *accelerant_help; /**< @brief Accelerant type (default=0) help description.  */
  ...
  unsigned int accelerant_given ;	/**< @brief Whether accelerant was given.  */
