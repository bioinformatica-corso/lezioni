/*
  ...
  gengetopt -i sa-matching.ggo --output-dir=./ --unamed-opts
...
const char *gengetopt_args_info_usage = "Usage: sa-matching [OPTIONS]... [FILES]...";

const char *gengetopt_args_info_versiontext = "";

const char *gengetopt_args_info_description = "Implementation of the pattern matching on a suffix array";
...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  -a, --accelerant=INT   Accelerant type (default=0)  (default=`0')",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->accelerant_arg = 0;
  args_info->accelerant_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->accelerant_help = gengetopt_args_info_detailed_help[5] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->accelerant_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->accelerant_given)
    write_into_file(outfile, "accelerant", args_info->accelerant_orig, 0);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVt:p:a:", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'p':	/* Pattern.  */
          ...
          break;
        case 'a':	/* Accelerant type (default=0).  */
        
        
          if (update_arg( (void *)&(args_info->accelerant_arg), 
               &(args_info->accelerant_orig), &(args_info->accelerant_given),
              &(local_args_info.accelerant_given), optarg, 0, "0", ARG_INT,
              check_ambiguity, override, 0, 0,
              "accelerant", 'a',
              additional_error))
            goto failure;
