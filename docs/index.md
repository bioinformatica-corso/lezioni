...
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
| A4  | GDV     | 10/10 | Suffix array e Suffix tree: definizioni. Suffix array e Suffix tree: relazioni. LCP                                     | Gusfield 5, 5.1, 5.2, 5.3, 5.4, 7.14. [dispensa](http://courses.csail.mit.edu/6.851/spring12/lectures/L16.pdf) [slides](https://github.com/bioinformatica-corso/lezioni/raw/master/04-pattern-matching-suffix-array-video.pdf) |                                        |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
| P2  | RR      | 21/10 | Dizionari e insiemi                                                                                                     | [Stringhe, liste e tuple](https://github.com/bioinformatica-corso/lezioni/blob/master/laboratorio/7ott19/lezione3-strutture-dati2.ipynb)                                                                                                               |                                        |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
...
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
| P7  | RR      | 2/11  | Esercizi con Biopython                                                                                                  |                                                                                                                |                                        |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
