...
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
| A2  | GDV     | 3/10  | Richiamo linguaggio C. Karp-Rabin: algoritmo e implementazione. Cenni di Python.                                        | [Introduzione a Python](laboratorio/7ott19/lezione1-introduzione.ipynb)                                                                                                               | [parole](c-esercizio-parole-frequenti) |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
