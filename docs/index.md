...
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
| P1  | RR      | 7/10  | Introduzione a Python. Stringhe, liste, tuple                                                                           | [Introduzione a Python](https://github.com/bioinformatica-corso/lezioni/blob/master/laboratorio/7ott19/lezione1-introduzione.ipynb)                                                                                                             |                                        |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                     | -------------                          | --------- |
