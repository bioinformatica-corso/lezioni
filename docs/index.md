...
| P3  | RR      | 7/10  |                                                                                                                         |                                                                                                                 |               |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                      | ------------- | --------- |
| A7  | GDV     | 2/10  | Ricerca della sottostringa comune più lunga di k stringhe: algoritmo e implementazione                                  | Gusfield 7.4                                                                                                    |               |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                      | ------------- | --------- |
...
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                      | ------------- | --------- |
| A10 | GDV     | 3/10  | Allineamento con banda. Allineamento con gap                                                                            | Gusfield 12.2.3, 12.2.4, 11.8                                                                                   |               |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                      | ------------- | --------- |
| P5  | RR      | 7/10  |                                                                                                                         |                                                                                                                 |               |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                      | ------------- | --------- |
| A11 | GDV     | 2/10  | Allineamento globale come caso generale di distanza di edit e LCS                                                       | Gusfield 11.6, 11.6.[1-2], 1.1, 4.1, 4.2.[1-2]                                                                  |               |           |
| --  | ---     | ----- | ---------                                                                                                               | ----------                                                                                                      | ------------- | --------- |
...
| P7 | RR      | 7/10  | 
|----- | ---------                                                                                                               | ----------                                                                                                      | ------------- | --------- |  
| A15 | GDV     | 2/10  | Filogenesi basata su caratteri | Gusfield 17.3, 17.6.1. Jones&Pevzner Capitolo 10
| -- | ---     | ----- | ---------                                                                                                               | ----------                                                                                                      | ------------- | --------- |  
